...
do
    case $opt in
        "QA")
            echo "you chose QA"
            sed -i "/datacenter/c\datacenter: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            S1="$opt"
    	    echo ""
	...
	do
    	    case $opt in
                "roinfraesx01.uipath.local")
            	  ...
            	  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            	  sed -i "/datastore/c\datastore: ROQADS01" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
                  ;;
        	"roinfraesx02.uipath.local")
            	  echo "you chose choice roinfraesx02.uipath.local"
                  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROQADS02" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
                  ;;
        	"roinfraesx03.uipath.local")
            	  echo "you chose choice roinfraesx03.uipath.local"
                  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROQADS03" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
                  ;;
        	"roinfraesx05.uipath.local")
            	  echo "you chose choice roinfraesx05.uipath.local"
            	  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROQADS05" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            	  break
            	  ;;
        	"roinfraesx08.uipath.local")
            	  echo "you chose choice roinfraesx08.uipath.local"
            	  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            	  sed -i "/datastore/c\datastore: ROQADS06" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
            	  ;;
        	"roinfraesx09.uipath.local")
            	  echo "you chose choice roinfraesx09.uipath.local"
            	  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROQADS07" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            	  break
            	  ;;
        	"roinfraesx10.uipath.local")
            	  echo "you chose choice roinfraesx10.uipath.local"
            	  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROQADS08" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            	  break
            	  ;;
      ...
      ;;
        ...
        do
            case $opt in
                "roinfraesx16.uipath.local")
                  ...
                  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: ROITDS01" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
                  ;;
		"roinfraesx17.uipath.local")
                  ...
                  do 
                      case $opt in
                          "DS_SAS_ESXi17")
                            ...
                            sed -i "/datastore/c\datastore: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                            break
                            ;;
                          "DS_SSD_ESXi17")
                ...
                "roinfraesx18.uipath.local")
                  ...
                  sed -i "/esxhost/c\esxhost: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  sed -i "/datastore/c\datastore: DS_SAS_ESXi18" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
                  break
                  ;;
                *) echo "invalid option $REPLY";;
              esac
...
PS3='Please enter your choice: '
options4=("Template-LinC6" "Template-LinC7" "Template-LinU16" "Template-LinU18" "Template-W8.1x86_new" "Template-W81x64_Enterprise_N" "Template-WIN10" "Template-Win10x86" "Template-Win2008R2" "Template-Win2012R2" "Template-Win2016" "Template-Win2019" "Template-Win7" "Template-Win7x86")
select opt in "${options4[@]}"
do
    case $opt in
        "Template-LinC6")
            echo "you chose Template-LinC6"
            sed -i "/vmtemplate/c\vmtemplate: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            break
            ;;
        "Template-LinC7")
        ...
        "Template-W81x64_Enterprise_N")
            ...
            ;;
        "Template-WIN10")
            echo "you chose choice Template-WIN10"
            sed -i "/vmtemplate/c\vmtemplate: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            break
            ;;
        "Template-Win10x86")
...
do
    case $opt in
        "2048")
            echo "you chose 2048"
            sed -i "/vm_memory/c\vm_memory: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            break
            ;;
        "3072")
...
do
    case $opt in
        "2")
            echo "you chose 2"
            sed -i "/nr_vcpus/c\nr_vcpus: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            break
            ;;
        "4")
...
do
    case $opt in
        "70")
            echo "you chose 70"
            sed -i "/disk_size/c\disk_size: ${opt}" /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            break
            ;;
        "80")
                      ...
                      do
                          case $opt in
                              "incremental VMs")
                                  ...
                                  echo "" > /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
                                  echo -e "--- \nserverlist:" > /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
                                  for (( i=1; i<= $vmnumber; i++ ))
                                      do
                                         echo -e " - $vmname$i" >> /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
                              ...
                              "multiple VMs")
                                  ...
                                  for (( i=1; i<= $vmnumber; i++ ))
                                      do
                                         ...
                                         read vmname
                                         echo -e " - $vmname" >> /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
                                 done
#                                 echo "The deployment will be triggered"
#                                 ansible-playbook ansible-vmware/vmware_create_infra.yml --ask-vault-pass
                                 break
        ...
        "no")
            ...
            echo "" > /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
            echo -e "--- \nserverlist: \n - $vmname" > /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
#            echo "The deployment will be triggered"
#            ansible-playbook ansible-vmware/vmware_create_infra.yml --ask-vault-pass
            break
            ;;
...
do
    case $opt in
        "yes")
            ...
            sed -n '2p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            sed -n '4p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            sed -n '6p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            sed -n '8p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            sed -n '9p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            sed -n '10p' /home/ansible/ansible-vmwareanddomain/group_vars/all.yml
            echo "VMs to be created:"
            tail -n +3 /home/ansible/ansible-vmwareanddomain/group_vars/hostname.yml
            echo ""
            ...
            do
               case $opt in
                   "yes")
                    ...
                    echo ""
                    echo "The deployment will be triggered"
                    ansible-playbook -v ansible-vmwareanddomain/vmware_create_infraanddomain.yml --ask-vault-pass
